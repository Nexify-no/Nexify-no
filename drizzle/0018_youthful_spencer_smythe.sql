...
CREATE TABLE `scheduling_preferences` (
	...
	`user_id` int NOT NULL,
	`timezone` varchar(50) NOT NULL DEFAULT 'UTC',
	`linkedin_best_days` json,
	`linkedin_best_hours` json,
	`twitter_best_days` json,
	`twitter_best_hours` json,
	`instagram_best_days` json,
	`instagram_best_hours` json,
	`facebook_best_days` json,
	`facebook_best_hours` json,
