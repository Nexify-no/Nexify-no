      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
            <p>
              Ved å registrere deg, få tilgang til eller bruke Penna-tjenesten ("Tjenesten") som tilbys av Nexify CRM Systems AS ("vi", "oss", "vår"), godtar du å være bundet av disse vilkårene for bruk ("Vilkår").
            </p>
        ...
        <Card className="mb-6">
          ...
          <CardContent className="space-y-4">
            <p>
              Penna er en AI-drevet plattform som hjelper brukere med å generere profesjonelt innhold for sosiale medier, inkludert LinkedIn, Twitter/X, Instagram og Facebook.
            </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-muted p-4 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">E-post: support@penna.no</p>
