...
const FALLBACK_FAQS = [
  ...
  { id: "f2b", category: "Komme i gang", question: "Hva teller som et innlegg?", answer: "Hvert nye innlegg du genererer teller mot grensen. Å forbedre, regenerere eller redigere et eksisterende innlegg teller ikke som et nytt. De 2 gratis innleggene er en engangs prøve, ikke 2 per måned." },
