...
/**
 * AuroraLayer — the aurora visual as a positioned background layer (no full-height
 * wrapper). Drop it inside any `relative` container and render real content above it
 * with a higher z-index. Used as the hero background on the landing page.
 */
